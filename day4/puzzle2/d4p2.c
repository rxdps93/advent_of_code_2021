...
int main() {
    ...
    Board current_board;
    Board worst_board;
    board_init(&worst_board);
    int status, moves, score;
    int most_moves = INT_MIN;
    do {
    ...
    score = board_score(&worst_board);

    printf("\nSLOWEST BOARD:\n");
    print_board(&worst_board);
    printf("\nWon with %d on move %d\n", worst_board.win_num, most_moves);
    printf("%5d\n%5d\n-----\n%5d\n", score, worst_board.win_num, score * worst_board.win_num);
