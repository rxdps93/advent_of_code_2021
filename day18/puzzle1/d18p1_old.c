...
Node add(Node *a, Node *b) {
    ...
    if (is_null(a)) {
        printf("first\n");
        create_node(&node, b->left_value, b->right_value, b->parent, b->left_child, b->right_child);
        return node;
    }
    ...
    if (is_null(b)) {
        printf("second\n");
        create_node(&node, a->left_value, a->right_value, a->parent, a->left_child, a->right_child);
        return node;
    }
